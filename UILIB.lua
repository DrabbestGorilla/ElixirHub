...
local objects = {}
local themes = {
	Background = Color3.fromRGB(39, 24, 60),
	Glow = Color3.fromRGB(192, 72, 255),
	Accent = Color3.fromRGB(39, 27, 62),
	LightContrast = Color3.fromRGB(192, 72, 255),
	DarkContrast = Color3.fromRGB(51, 36, 73),  
